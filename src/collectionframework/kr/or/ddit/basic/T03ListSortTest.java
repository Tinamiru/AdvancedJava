...
public class T03ListSortTest {
	 ...
	 * 
	 * - Comparable에서는 compareTo()를 구현해야하고, Comparator에서는 compare()를 구현해야 한다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * 정렬은 Collection.sort()를 이용하여 정렬한다. 정렬은 기본적으로 '오름차순' 정렬을 수행한다.
		 * 
		...
		System.out.println("외부 정렬자 이용한 정렬 후 : " + list);
 ...
 * <p>이 Comparator라는 인터페이스의 compare() 메서드를 재정의하여 구현하면 된다.
 * 
 * @author JayAl
 */
class Desc implements Comparator<String> {
	...
	public int compare(String str1, String str2) {
		/*
		 * compare()의 반환값을 결정하는 방법 => 오름차순이 기본값이다.
		 * 
		 * - 오름차순 정렬일 경우 => 앞의 값이 크면 양수, 같으면 0, 앞의 값이 작으면 음수를 반환하도록 구현.
		 */
