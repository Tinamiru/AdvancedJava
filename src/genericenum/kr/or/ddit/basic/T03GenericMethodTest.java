...
public class T03GenericMethodTest {
	public static void main(String[] args) {
		...
		Pair<Integer, String> p3 = new Pair<Integer, String>(001, "홍길동");
		Pair<Integer, String> p4 = new Pair<Integer, String>(002, "홍길동");

		boolean result2 = util.<Integer, String>compare(p3, p4);
